...
class PlayState extends MusicBeatState
{
	...
	public function startVideo(nomedovideo:String)
		{
			inCutscene = true;
	
			var arquivopath:String = "assets/videos/" + nomedovideo;
			if(!OpenFlAssets.exists(arquivopath))
			{
				FlxG.log.warn('Não foi possível achar o vídeo: ' + nomedovideo);
			} else {
			
				MusicBeatState.switchState(new VideoState(arquivopath, new PlayState()));
		}
	}
